...
※단 역할은 보통 쓰는거에 대한 설명이지 확실히 정해져있는게 아니다. ex) 딜러형 서폿
...
|Diffgold|Gold 격차|골드 격차가 난다는것은 보다 라인전을 유리하게든 킬을 많이 먹었던간에 유리했다는것이고 보다 상위템을 빨리가서 더욱 유리한 상황을 이끌어갈수있음을 알수있다.|
|Goldearned100|블루팀 총 획득 골드|팀원이 더욱 유리한 상황을 이끌어갔음을 알수있다.|
|Goldearned200|레드팀 총 획득 골드|"|
|Dragon|드래곤 처치 수|드래곤은 처치하면 버프를 주는데 해당 버프로인해 게임이 유리해진다. 또한 그만큼 중요한 오브젝트여서 서로 먹으려 하는데 그것을 먹었다는것은 보다 유리한 상황을 이끌어갔음을 알수있다.|
|Baron|내셔남작 처치 수|냄셔남작은 처치하면 버프를 주는데 해당 버프로인해 게임이 유리해진다. 또한 그만큼 중요한 오브젝트여서 서로 먹으려 하는데 그것을 먹었다는것은 보다 유리한 상황을 이끌어갔음을 알수있다.|
|Visionscore100|블루팀 시야점수|보다 남의 진형에 많이들어갈수있엇다는 상황을 알려줌과 동시에 상대의 행동동선을 알수있어 더욱 유리함을 알수있다.|
